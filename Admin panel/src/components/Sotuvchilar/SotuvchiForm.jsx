...
const SotuvchiForm = ({ sotuvchi, onSubmit, onCancel, loading }) => {
  ...
  useEffect(() => {
    if (sotuvchi) {
      setFormData({
        ...
        telefonRaqam: sotuvchi.telefonRaqam || '',
        status: sotuvchi.status || 'active',
      });
    }
  }, [sotuvchi]);
